from cuda_code.final.evaluate import error, evaluate, update_velocity, update_position
from multiprocessing import Manager, Process, Lock
from cuda_code.final.init_particles import create_n_particles
from numba import jit
import numpy as np


#@jit
def PSO_purana(costFunc,bounds,max_iter,swarm_init=None):
    try:  
        num_dimensions= len(swarm_init[0])
    except:
        print('no values inside swarm_init ', swarm_init)
